...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.recover_logs = channel.unary_unary(
                ...
                _registered_method=True)
        self.subscribe_to_leader = channel.unary_unary(
                '/raft_service.RaftService/subscribe_to_leader',
                request_serializer=grpc__start_dot_raft__pb2.String.SerializeToString,
                response_deserializer=grpc__start_dot_raft__pb2.Empty.FromString,
                _registered_method=True)
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'subscribe_to_leader': grpc.unary_unary_rpc_method_handler(
                    servicer.subscribe_to_leader,
                    request_deserializer=grpc__start_dot_raft__pb2.String.FromString,
                    response_serializer=grpc__start_dot_raft__pb2.Empty.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    @staticmethod
    def subscribe_to_leader(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft_service.RaftService/subscribe_to_leader',
            grpc__start_dot_raft__pb2.String.SerializeToString,
            grpc__start_dot_raft__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
